...
function Success() {
  ...
  const [openseas, setOpenseas] = useState(`https://testnets.opensea.io/${walletAddress}`);
  ...
  return (
    <div>
      ...
      <div className="details">
        ...
        <h5>
          View Your NFT Metadata uploaded using NFTStorage by Filecoin: <a href={metadataURL}>{metadataURL}</a>
        </h5>
        <h5>View Your NFT on Openseas Page: <a href={openseas}>{openseas}</a> </h5>
      </div>
    </div>
  );
}
